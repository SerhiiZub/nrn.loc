...
/**
 * This is the model class for table "{{race_route}}".
 *
 * The followings are the available columns in table '{{race_route}}':
 * @property string $id
 ...
 */
class RaceRoute extends yupe\models\YModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, race_id, title, description, image, create_user_id, update_user_id, create_time, update_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return RaceRoute the static model class
	 */
