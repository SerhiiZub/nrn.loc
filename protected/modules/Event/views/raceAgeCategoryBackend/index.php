...
$this->pageTitle = Yii::t('EventModule.Event', 'Категории - управление');
...
<p>
    <a class="btn btn-default btn-sm dropdown-toggle" data-toggle="collapse" data-target="#search-toggle">
        ...
        <?=  Yii::t('EventModule.Event', 'Поиск Категориями');?>
...
<div id="search-toggle" class="collapse out search-form">
        ...
        $('.search-form form').submit(function () {
            $.fn.yiiGridView.update('race-age-category-grid', {
                data: $(this).serialize()
            });
...
<p> <?=  Yii::t('EventModule.Event', 'В данном разделе представлены средства управления Категориями'); ?>
</p>
