<?php
/**
 * EventModule основной класс модуля Event
 *
 * @author yupe team <team@yupe.ru>
 * @link http://yupe.ru
 * @copyright 2009-2018 amyLabs && Yupe! team
 * @package yupe.modules.Event
 * @since 0.1
 */

class EventModule  extends yupe\components\WebModule
{
    /**
     * @var int
     */
    ...
    {
        return Yii::t('EventModule.Event', 'Ewents');
    }
    ...
    {
        return [
            ['label' => Yii::t('EventModule.Event', 'Event')],
            [
                'icon' => 'fa fa-fw fa-list-alt',
                'label' => Yii::t('EventModule.Event', 'Index'),
                'url' => ['/Event/EventBackend/index']
            ],
        ];
    }
    ...
    {
        return Yii::t('EventModule.Event', self::VERSION);
    }
    ...
    {
        return Yii::t('EventModule.Event', 'http://yupe.ru');
    }
    ...
    {
        return Yii::t('EventModule.Event', 'Event');
    }
    ...
    {
        return Yii::t('EventModule.Event', 'Описание модуля "Event"');
    }
    ...
    {
        return Yii::t('EventModule.Event', 'yupe team');
    }
    ...
    {
        return Yii::t('EventModule.Event', 'team@yupe.ru');
    }
    ...
    {
        return '/Event/EventBackend/index';
    }
    ...
    public function getAuthItems()
    {
        return [
            [
                'name' => 'Event.EventManager',
                'description' => Yii::t('EventModule.Event', 'Manage Event'),
                'type' => AuthItem::TYPE_TASK,
                'items' => [
                    [
                        'type' => AuthItem::TYPE_OPERATION,
                        'name' => 'Event.EventBackend.Index',
                        'description' => Yii::t('EventModule.Event', 'Index')
                    ],
                ]
            ]
        ];
